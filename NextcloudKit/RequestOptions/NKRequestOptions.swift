...
public class NKRequestOptions: NSObject {
    ...
    public init(endpoint: String? = nil, customHeader: [String: String]? = nil, customUserAgent: String? = nil, contentType: String? = nil, timeout: TimeInterval = 60, queue: DispatchQueue = .main) {
