...
public extension NextcloudKit {
    ...
    func unifiedSearch(term: String,
        ...
        let requestUnifiedSearch = nkSession.sessionData.request(url, method: .get, parameters: nil, encoding: URLEncoding.default, headers: headers).validate(statusCode: 200..<300).onURLSessionTaskCreation { task in
