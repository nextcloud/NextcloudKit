...
public extension NextcloudKit {
    ...
    func getDownloadLimit(account: String, token: String, completion: @escaping (NKDownloadLimit?, NKError) -> Void) {
        ...
        nkSession
            .sessionData
            .request(url, method: .get, parameters: nil, encoding: URLEncoding.default, headers: headers)
    ...
    func removeShareDownloadLimit(account: String, token: String, completion: @escaping (_ error: NKError) -> Void) {
        ...
        nkSession
            .sessionData
            .request(url, method: .delete, parameters: nil, encoding: URLEncoding.default, headers: headers)
            .validate(statusCode: 200..<300)
