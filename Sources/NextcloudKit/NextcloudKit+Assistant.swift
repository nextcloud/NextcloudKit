...
public extension NextcloudKit {
    ...
    func textProcessingGetTypes(account: String,
                                ...
                                completion: @escaping @Sendable (_ account: String, _ types: [NKTextProcessingTaskType]?, _ responseData: AFDataResponse<Data>?, _ error: NKError) -> Void) {
    ...
    func textProcessingSchedule(input: String,
                                ...
                                options: NKRequestOptions = NKRequestOptions(),
                                taskHandler: @escaping @Sendable (_ task: URLSessionTask) -> Void = { _ in },
                                completion: @escaping @Sendable (_ account: String, _ task: NKTextProcessingTask?, _ responseData: AFDataResponse<Data>?, _ error: NKError) -> Void) {
