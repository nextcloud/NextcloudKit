...
public extension NextcloudKit {
    ...
    func getAppPassword(url: String,
        ...
        Session.MPTCPSession.request(urlRequest).validate(statusCode: 200..<300).onURLSessionTaskCreation { task in
    ...
    func getLoginFlowV2(serverUrl: String,
        ...
        Session.MPTCPSession.request(url, method: .post, parameters: nil, encoding: URLEncoding.default, headers: headers, interceptor: nil).validate(statusCode: 200..<300).onURLSessionTaskCreation { task in
            task.taskDescription = options.taskDescription
            taskHandler(task)
